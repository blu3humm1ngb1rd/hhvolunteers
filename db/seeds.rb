...
pride = Project.create(name: 'Pride 2020', completed: 1, assigned: 1, role: 'coordinator', number_of_hours: 8, date: '9/20/20', time: '10a')
shefest = Project.create(name: 'Virtual SheFEST', completed: 1, assigned: 1, role: 'interpreter', number_of_hours: 8, date: '11/1/20', time: '12p')
